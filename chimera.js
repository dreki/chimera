...
/*global undefined*/
/*eslint camelcase: 0*/
define([ 'base/base', 'helpers/utils', 'lodash', 'backbone', 'jquery', 'lib/backbone-validation', 'backbone.stickit', ], function (Base, utils, _, Backbone, $) {
  'use strict';
   ...
   * @type {Backbone.View}
   */
  var QuizView = Base.View._.extend({
